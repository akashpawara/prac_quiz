<?php
  ...
  if(isset($_POST['signsubmit']))
  {
     ...
     if(!$row = mysqli_fetch_array($result))
     {
       if($access== "vesp123")
       {
          $query = "INSERT INTO teacher". "(id,name,email,username,password,access)". "VALUES(NULL,'$name','$email','$user','$pass','$access')";
        ...
        {
          echo '<script type="text/javascript">'.
        'window.alert("Access code didnt Matched...");'.
        'window.location.href="neologin";'.
        '</script>';
        }
     }
  ...
  <body>
    <input type="submit" onclick=window.location.href="http://localhost/prac-quiz/pracquiz/home" value="Back">
      ...
      <h1>Teacher's Login</h1>
        ...
        <div class="tab-content">
          ...
          <div id="signup">
            ...
            <div class="field-wrap">
              <label>
                Access Code<span class="req">*</span>
              </label>
              <input type="password" id="access" name="access" required autocomplete="off"/>
            </div>
