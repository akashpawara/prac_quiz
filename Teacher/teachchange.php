<html>
   ...
   <head>
     <input type="button" value="Back" onclick="window.location.href='homepage';"/><br><br>
     ...
     <div id="page-wrap">
      ...
      $id=$_GET['id'];
         if(isset($_POST['update']))
          {
            $sql1="select password from teacher where id='$id'" ;
            ...
            if($curpass == $opass)
            {
            $sql = "UPDATE teacher ". "SET password = '$pass' ".
             "WHERE id = $id" ;
