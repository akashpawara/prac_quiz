<html>
   ...
   <head>
     <input type="button" value="Back" onclick="window.location.href='estretval';"/><br><br>
     ...
     <div id="page-wrap">
      ...
      include("session.php");
         if(isset($_POST['add'])) {
            ...
            $sql = "SELECT * FROM est WHERE ques = '$ques' ";
            ...
            if(!$row = mysqli_fetch_array($check))
            {
              ...
              $sql = "INSERT INTO est". "(id,ques,opa,opb,opc,opd,ans)". "VALUES(NULL,'$ques','$opa','$opb','$opc','$opd','$ans')"; ;
           ...
           'window.location.href="estretval.php";'.
           '</script>';
             }
         }
